    ...
    data() {
        return {
            ...
            projects: [
                {
                    title: "✨ Ô Ăn Quan AI",
                    text: "A Vietnamese traditional board game, Ô Ăn Quan, as a web app with an AI that uses the Minimax algorithm with Alpha-Beta pruning and Reinforcement Learning to play against human players. CI/CD with GitHub Actions.",
                    links: ["https://github.com/huyenngn/OAnQuan-AI", "https://huyenngn.github.io/oanquan"],
                    technologies: ["Python", "PyTorch", "FastAPI", "Javascript", "Vue.js", "HTML", "CSS", "SQL", "Supabase", "Docker", "GitHub Actions", "CI/CD"],
                },
                {
                    title: "💻 LinuxTyper",
